...
// _fonts.scss - ты пропустил коммент, я тебе для этого пприсылал скрин чтобы ты проверил, внимательнее ⚠️
//  Я не вижу там лишнего пробела. Посмотрел через CMD+F, он распознает и показывает в том числе double-space, но его там нет.
